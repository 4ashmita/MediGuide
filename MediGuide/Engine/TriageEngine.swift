...
final class TriageEngine: ObservableObject {
    ...
    func setSessionBloodType(_ bloodType: String) { session.sessionBloodType = bloodType }
    func setSessionDisplayName(_ name: String) { session.sessionDisplayName = name }
    func setSessionAge(_ age: Int) { session.sessionAge = age }
    func setConditionsExplicitlyProvided(_ provided: Bool) { session.conditionsExplicitlyProvided = provided }
